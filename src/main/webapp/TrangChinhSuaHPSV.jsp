                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Chỉnh sửa học phần sinh viên</h2>
                                        </div>
                        ...
                        <div id="editEmployeeModal">
                            <div class="modal-dialog">
                                ...
                                <!-- Nếu 2 form trong 1 trang cùng action đến 1 servlet và cùng method thì server sẽ bị lỗi -->
                                    <form action="editHP_SV" method="post">
                                        
                                        <div class="modal-body">				
                                        	<div class="form-group">
                                                <label>Mã lớp</label>
                                                <input value="${hpsv.maLop}" type="text" class="form-control" name="maLop" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Mã sinh viên</label>
                                                <input value="${hpsv.maSV}" type="text" class="form-control" name="maSV" >
                                            </div>
                                            <div class="form-group">
                                                <label>Điểm</label>
                                                <input value="${hpsv.diem}" type="text" class="form-control" name="diem" >
                                            </div>
                                        
                                            <div class="form-group">
                                                <label>Trạng thái học</label>
                                                <input value="${hpsv.trangThaiHoc}" type="text" class="form-control" name="trangThaiHoc" >
                                            </div>		
                                        </div>
