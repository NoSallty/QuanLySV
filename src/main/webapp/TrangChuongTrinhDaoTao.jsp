                                    ...
                                    <tbody>
                                    	<c:forEach var="x" items="${listS}">
											<tr>
												...
												<td><a href="chitiethp?mahp=<c:out value="${x.maHP}"/>">Chi tiết</a></td>
												<td>
		                                        	<a href="editSubject?smaHP=<c:out value="${x.maHP}"/>"class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
		                                            <a href="#" onclick="showMess(<c:out value="'${x.maHP}'" />)" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
		                                     	</td>
											</tr>
										</c:forEach>
                                    </tbody>    
